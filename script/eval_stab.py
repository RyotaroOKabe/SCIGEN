...
# Local imports
sys.path.append('../')
from config_scigen import gnn_eval_path, home_dir, hydra_dir, job_dir, out_name, stab_pred_name_A, stab_pred_name_B
...
from eval_funcs import load_model, parse_arguments, process_data, load_df, classify_stability, generate_cif_files
...
def main():
    ...
    if args.gen_cif:
        generate_cif_files(df4, cif_dir, logger)
