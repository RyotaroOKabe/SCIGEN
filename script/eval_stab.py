...
# Local imports
sys.path.append('../')
from config_scigen import gnn_eval_path, home_dir, hydra_dir, job_dir, out_name, stab_pred_name_A
...
from gnn_eval.utils.model_class import GraphNetworkClassifier# , generate_dataframe
...
def main():
    ...
    if args.gen_cif:
        generate_cif_files(df4, cif_dir)
